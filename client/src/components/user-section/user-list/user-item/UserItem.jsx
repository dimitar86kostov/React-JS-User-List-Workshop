...
export default function UserItem({ user, showDetailsBtn, showDeleteModal }) {
        ...
        <tr>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pen-to-square" className="svg-inline--fa fa-pen-to-square" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 532 512">
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => showDeleteModal(user._id)}>
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash" className="svg-inline--fa fa-trash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 498 512">
                ...
                <button className="btn info-btn" title="Info" onClick={() => showDetailsBtn(user._id)}>
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="info" className="svg-inline--fa fa-info" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="-150 0 512 612">
